...
import imgSrc from '../2.png'; // Adjust the path as necessary
...
export default function HomePage() {
  ...
  return (
    <div className="text-center py-20 bg-gray-100 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="lg:w-1/2 flex justify-center items-center mt-8 lg:mt-0">
          <img
            src='../logohero.jpg'
            alt="Hero Image"
            className="rounded-lg h-80 w-80 shadow-lg"
          />
        </div>
      </div>
      {/* Divider Section */}
